...
实测:`tools/ci.py` 沙箱离线 = 通过 11 · 失败 0 · 跳过 1;`--online` = 通过 16 · 失败 0 · 跳过 0
(厂商页 15/15、权威文档 66/66、昇腾矩阵与 31 份教程 sha256 未漂移);云端 Actions 运行 #13(`92b3f6b`)成功。
...
跳过 0(厂商页 15/15、权威文档 66/66、昇腾矩阵与 31 份教程 sha256 未漂移);云端 Actions 运行 #10(`eb75fb6`)与 #11(`8ebd268`)成功。
