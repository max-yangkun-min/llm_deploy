...
echo "  MODEL_SOURCE=\${MODEL_SOURCE:-$(dirname "${PKG}")/offline-xt/models/MiniMax-M2.7-AWQ}"
echo "  CUDA_VISIBLE_DEVICES=0,1,2,3 vllm serve \${MODEL_SOURCE} \\"
...
echo "  第二副本使用GPU 4-7和端口8002，参数同上。"
